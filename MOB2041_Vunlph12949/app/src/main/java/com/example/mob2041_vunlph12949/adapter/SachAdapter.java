...
public class SachAdapter extends RecyclerView.Adapter<SachAdapter.SachViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull SachViewHolder holder, int position) {
        ...
        if(holder.tvTenSach.getText().toString().contains("n")){
            holder.tvMaSach.setTextColor(Color.GREEN);
            Log.e("Dunggggg", "ok");
        }
        ...
        String sale = formatter.format(sach.getKhuyenMai());
        holder.tvKhuyenMai.setText("Khuyến mãi: " + sale + " vnđ");
    ...
    public class SachViewHolder extends RecyclerView.ViewHolder {
        TextView tvMaSach, tvTenSach, tvGiaThue, tvMaLoai, tvKhuyenMai;
