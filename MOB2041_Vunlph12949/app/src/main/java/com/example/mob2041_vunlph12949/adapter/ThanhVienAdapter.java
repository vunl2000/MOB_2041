...
public class ThanhVienAdapter extends RecyclerView.Adapter<ThanhVienAdapter.ThanhVienViewHolder> {
    ...
    public void onBindViewHolder(@NonNull @NotNull ThanhVienViewHolder holder, int position) {
        ...
        if (position == 0 || position % 2 == 0) {
            holder.tvMaTV.setTextColor(Color.RED);
            holder.tvHoTen.setTextColor(Color.RED);
            holder.tvNamSinh.setTextColor(Color.RED);
        }else {
            holder.tvMaTV.setTextColor(Color.GREEN);
            holder.tvHoTen.setTextColor(Color.GREEN);
